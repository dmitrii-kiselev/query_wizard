...
class QueryWizardOptions {
  const QueryWizardOptions({
    this.themeMode,
  ...
  static QueryWizardOptions of(BuildContext context) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
    return scope!.modelBindingState.currentModel;
  }

  static void update(BuildContext context, QueryWizardOptions newModel) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
...
// Applies text QueryWizardOptions to a widget
class ApplyTextOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = QueryWizardOptions.of(context);
...
class ModelBinding extends StatefulWidget {
  const ModelBinding({
    Key? key,
    this.initialModel = const QueryWizardOptions(timeDilation: 1.0),
    required this.child,
  }) : super(key: key);

  final QueryWizardOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  late QueryWizardOptions currentModel;
  ...
  void handleTimeDilation(QueryWizardOptions newModel) {
  ...
  void updateModel(QueryWizardOptions newModel) {
