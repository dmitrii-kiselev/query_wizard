...
import 'package:query_wizard/src/application/blocs/query_orders/query_orders_bloc.dart';
...
class QueryOrdersTab extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<QueryOrdersBloc, QueryOrdersState>(builder: (
      context,
      state,
    ) {
      return Scaffold(
                  ...
                  leading: Wrap(
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          bloc.add(
                            QueryOrdersEvent.orderDeleted(index: index),
                          );
                        },
                      ),
                    ],
